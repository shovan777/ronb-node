...
export class PublicToiletService {
    ...
    async create(publicToiletInput: CreatePublicToiletInput): Promise<PublicToilet> {
        let publicToiletInputData = { ...publicToiletInput, singleImage:null, images: null };
        ...
        const publicToiletData: PublicToilet = await this.publicToiletRepository.save({
            ...publicToiletInputData,
    ...
    async update(id: number, updatePublicToiletInput: UpdatePublicToiletInput) {
        const publicToilet: PublicToilet = await this.publicToiletRepository.findOne({
            where: {id:id},
        });
        if (publicToilet) {
