...
import { PublicToiletReview } from './reviews.entity';
...
export class PublicToilet {
  ...
  @Field({
    description: 'Public Toilet main image.',
    nullable: true,
  ...
  @Field(() => [PublicToiletImage], {
    description: 'Public Toilet image',
    nullable: true,
  })
  @OneToMany(
    () => PublicToiletImage,
    (publicToiletImage) => publicToiletImage.publicToilet,
    { nullable: true },
  )
  images?: PublicToiletImage[];

  @Field(() => [PublicToiletReview], {
    description: 'Public Toilet Review',
    nullable: true,
  })
