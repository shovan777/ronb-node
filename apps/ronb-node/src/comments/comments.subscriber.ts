...
@EventSubscriber()
export class NewsReplySubscriber
  implements EntitySubscriberInterface<NewsReply>
{
  constructor(
  ...
  async afterInsert(event: InsertEvent<NewsReply>): Promise<any> {
    ...
    const comment = await this.newsCommentService.findOneWithNews(
      entity.comment.id,
    );
...
@EventSubscriber()
export class UserLikesNewsCommentSubscriber
  implements EntitySubscriberInterface<UserLikesNewsComment>
{
  constructor(
    dataSource: DataSource,
    @Inject(NotificationsService)
...
@EventSubscriber()
export class UserLikesNewsReplySubscriber
  implements EntitySubscriberInterface<UserLikesNewsReply>
{
  constructor(
    dataSource: DataSource,
    @Inject(NotificationsService)
